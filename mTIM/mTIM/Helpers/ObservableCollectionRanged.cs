...
namespace mTIM.Helpers
{
    ...
    public class ObservableCollectionRanged<T> : ObservableCollection<T>
    {
        ...
        /// </summary>
        public ObservableCollectionRanged() { }
        ...
        public int RemoveAll(int index, int count, Predicate<T> match)
        {
            ...
            if (Count == 0)
            {
                OnCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Remove, 0, index));
                return 0;
            }
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="count"/> is out of range.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="collection"/> is null.</exception>
        private void ReplaceRange(int index, int count, IEnumerable<T> collection)
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="collection"/> is null.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="comparer"/> is null.</exception>
        private void ReplaceRange(int index, int count, IEnumerable<T> collection, IEqualityComparer<T> comparer)
        {
            if (index < 0)
                throw new ArgumentOutOfRangeException(nameof(index));
            if (count < 0)
        ...
        {
            private readonly ObservableCollectionRanged<T> _collection;
            public DeferredEventsCollection(ObservableCollectionRanged<T> collection)
            {
