...
namespace mTIM
{
    public class mTIMBottomSheet : ContentView
    {
        ...
        public Grid GridContent { set; get; }
        public mTIMBottomSheet()
        {
        ...
        public static readonly BindableProperty ViewProperty = BindableProperty.Create(
           ...
           declaringType: typeof(mTIMBottomSheet),
           defaultValue: null);
        ...
        protected override void OnBindingContextChanged()
        {
            ...
            if (FadeBackgroundEnabled)
            {
                ...
                GridContent.Children.Add(Fade, 0, 0);
            ...
            switch (ContentPosition)
            {
                case Positions.Bottom:
                    GridContent.Children.Add(this.View, 0, 1);
                    break;
                case Positions.Top:
                    GridContent.Children.Add(this.View, 0, 0);
                    break;
                case Positions.Left:
                    GridContent.Children.Add(this.View, 0, 0);
                    break;
        ...
        public void Open()
        {
            Device.BeginInvokeOnMainThread(
               ...
               =>
               {
                   ...
                   if (FadeBackgroundEnabled)
                   {
                       await View.FadeTo(1, ExpandAnimationSpeed * 2, Easing.SinInOut);
                   }
               });
        ...
        public void Close()
        {
            Device.BeginInvokeOnMainThread(
                ...
                =>
                {
                    if (FadeBackgroundEnabled)
                    {
                        await View.FadeTo(0, CollapseAnimationSpeed / 2, Easing.SinInOut);
                    }
        ...
        {
            var control = bindable as mTIMBottomSheet;
            if (newValue is true)
            {
                control.Open();
            }
